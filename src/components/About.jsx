...
export default function About() {
  ...
  const skillLogos = {
    ...
    Python: <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M12 2C8 2 8 5 8 5v3h8V6s0-4-4-4zM6 10s-4 0-4 4 4 4 4 4h3v-3H6s0-1 0-2 0-2 2-2h4v-3H6zm12 0h-4v3h3v3s0 1 0 2-2 2-2 2h-4v3s0 3 4 3 4-3 4-3v-3h-8v-2s4 0 4-4-4-4-4-4z"/></svg>,
    ...
    <section id="about" ref={sectionRef}>
      ...
      <div className={`terminal-window ${isVisible ? 'visible' : ''}`}>
        ...
        <div className="terminal-body">
          ...
          <div className="term-output bio-text">{bio}</div>
